...
class Board
{
    ...
    bool addPawnAndCheckForWin(const PawnColour target_pawn_colour, const unsigned char moves,
    ...
    void generateAllPossibleTurns(const PawnColour pawn_colour, const bool should_win,
